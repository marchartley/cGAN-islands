...
\teaser{
    \autofitgraphics[]{/media/marc/Data/NN Datasets/1/noise_renders/num_1/Render--demo-3--.png, /media/marc/Data/NN Datasets/1/noise_renders/num_1/Render--demo-13--.png, /media/marc/Data/NN Datasets/1/noise_renders/num_1/Render--demo-21--.png}% terrainGAN.png, terrainGAN_result.png}
    \centering
    \caption{From top-view and profile-view sketches, our system procedurally generates coral reef islands and trains a cGAN to produce diverse and realistic terrains.}
    \label{fig:teaser_cGAN}
}
