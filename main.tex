...
\teaser{
    \autofitgraphics[]{Teaser1.png, Teaser2.png, Teaser3.png}% terrainGAN.png, terrainGAN_result.png}
    \centering
    \caption{Given a free hand-drawn sketch of the different regions of an island, our method generate a corresponding height field using neural networks. Subsidence (gradual sinking of land) is controlled by the user in the luminosity channel of the input.}
    \label{fig:teaser_cGAN}
}
